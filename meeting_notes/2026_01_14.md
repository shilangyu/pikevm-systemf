...
- We need a proof of `codesize r = O(regex_size r)`. Should be easy, can I add it? -> there is already a form of this with regards to [`compsize`](https://github.com/LindenRegex/Linden/blob/9227956fb92519482827f41a28e16f9d0d3349a0/Engine/Complexity.v#L552)
