...
#linden-theorem("Engine/Prefix.v", "extract_literal_prefix_general", proof: [
  We induction on the ```rocq is_tree``` hypothesis and use @thm:correctness-extract-literal-char.
