...
We proceed by showing that we can exhibit an instance of this typeclass by implementing a naive brute-force substring search algorithm. Its somewhat ugly definition given in @lst:naive-substring-search stems from it being primarily written to facilitate the ease of proofs.
