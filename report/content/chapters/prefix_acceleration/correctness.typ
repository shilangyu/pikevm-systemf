...
The new unanchored PikeVM has an executable functional version#note[Defined in #linden-permalink(linden-statement("Engine/FunctionalPikeVM.v", "pike_vm_match_unanchored"))] which is proven to follow exactly the small-step semantics#note[Proven in #linden-permalink(linden-statement("Engine/FunctionalPikeVM.v", "pike_vm_match_correct_unanchored"))].
